...
class ItemUsesTest {
	...
	void aSlotHeldStillIsParsedOnceNoMatterHowLongItIsOnScreen() {
		...
		LoreComponent held = lore("Smelling Salts", "Charges: 2");
	...
	void theCommonCaseOfNoChargesAtAllIsRememberedToo() {
		...
		LoreComponent plain = lore("A Deluxe Voter Sword", "Sharpness V", "Unbreaking III");
		for (int frame = 0; frame < FRAMES; frame++) {
