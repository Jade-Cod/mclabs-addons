...
public class RaidMineHudObject extends LabeledTimerHudObject {
	...
	public EditorAction editorAction() {
		return new EditorAction(Component.translatable("labsaddons.hud.raid_mine.clear"), RaidMineTracker::clear);
	}

	@Override
	@Nullable
	protected Component header(boolean preview) {
		return Component.translatable("labsaddons.hud.raid_mine.double_drops");
	}
