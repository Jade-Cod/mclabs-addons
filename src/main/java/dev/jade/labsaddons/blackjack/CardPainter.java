...
public final class CardPainter {
	...
	public static void draw(GuiGraphicsExtractor context, Font font, int x, int y, Card card) {
		draw(context, font, x, y, card, 0);
	}

	public static void draw(GuiGraphicsExtractor context, Font font, int x, int y, Card card, int glowColor) {
		...
		context.text(font, rank, x + 2, y + 2, ink, false);
	...
	private static void back(GuiGraphicsExtractor context, int x, int y, int glowColor) {
