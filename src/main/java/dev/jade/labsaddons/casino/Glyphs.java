...
public final class Glyphs {
	 ...
	 */
	public static void draw(GuiGraphicsExtractor context, int[] glyph, int x, int y, int pixel,
			int color) {
	...
	public static void centred(GuiGraphicsExtractor context, int[] glyph, int x, int y, int w, int h,
			int pixel, int color) {
